...
export const portfolioData: PortfolioContent = {
  ...
  works: [
    ...
    },
    {
      ...
      liveUrl: 'https://icas-cmu.turnpro.dev',
      ...
      gallery: [
        ...projectGalleryFrames(ICAS, Array.from({ length: 18 }, (_, i) => i + 1)),
        projectImage(ICAS, 'Screenshot 2569-05-22 at 21.36.46.png'),
      ] as unknown as NonEmptyArray<string>,
      description:
        'A production CMU club platform for memberships, events, assignments, live chat, and admin workflows — live at icas-cmu.turnpro.dev.',
      stack: [
        'React',
        'TypeScript',
        'Tailwind',
